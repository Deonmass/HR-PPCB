/**
 * Rebuilds Excel/templates/dependants/DEPENDANTS_EXPORT_TEMPLATE.xlsx from a formatted EMPLOYEE workbook.
 *
 * Usage:
...
const OUTPUT = path.join(root, 'Excel', 'templates', 'dependants', 'DEPENDANTS_EXPORT_TEMPLATE.xlsx');
