...
export default function EmployeesLineChart({ title, items, color = '#60a5fa' }: Props) {
  ...
  return (
    <EnlargeableChartPanel title={title} className="travel-history-chart-panel" clickToEnlarge>
