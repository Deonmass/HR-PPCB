...
export const AUDIT_MODULE_LABELS: Record<string, string> = {
  ...
  'travel.mission.kinshasa': 'Ordre de mission — Kinshasa',
  'travel.mission.zamba': 'Ordre de mission — Zamba PPC Team',
  'travel.mission.zamba-consultant': 'Ordre de mission — Zamba Consultant',
  'travel.mission.lubudi': 'Ordre de mission — Lubudi',
  ...
  'politique.manuco': 'Politique — Règlement Manuco',
  'politique.aide-medicale': 'Politique — Aide médicale',
