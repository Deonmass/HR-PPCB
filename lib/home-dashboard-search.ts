...
function moduleShortcuts(menus: MenuPermission[]): Array<{
  ...
  const all = [
    ...
    { title: 'Politique', subtitle: 'Politiques RH de référence', href: '/politique', menuIds: ['politique.longs-etats', 'politique.convention-collective', 'politique.heures-sup', 'politique.village', 'politique.code-conduite', 'politique.code-ethique', 'politique.manuco', 'politique.aide-medicale', 'politique.voyages', 'politique.alcool', 'politique.harcelement', 'politique.exploitation', 'politique.cas-disciplinaires'] },
