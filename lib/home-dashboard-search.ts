...
function moduleShortcuts(menus: MenuPermission[]): Array<{
  ...
  const all = [
    ...
    { title: 'Classification des postes', subtitle: 'Grille Hay, Paterson, recrutement et mouvements', href: '/employes/classification', menuIds: ['employes.classification', 'employes.postes', 'employes.recrutement', 'employes.mouvements'] },
    ...
    { title: 'Santé', subtitle: 'Fiche journalière des pathologies', href: '/sante/dashboard', menuIds: ['sante.dashboard', 'sante'] },
    { title: 'Santé — Données', subtitle: 'Registre des cas et traitements', href: '/sante/donnees', menuIds: ['sante.donnees', 'sante'] },
    ...
    { title: 'Documents', subtitle: 'Hub documents RH', href: '/documents', menuIds: ['travel.historique', 'documents.rrf', 'documents.entetes', 'documents.exit', 'documents.newcomer', 'documents.contrat-standard', 'documents.contrat-bail', 'documents.composition-familiale', 'documents.mouvement-travailleur', 'travel.mission.kinshasa', 'travel.mission.zamba', 'travel.mission.zamba-consultant', 'travel.mission.lubudi'] },
    ...
    { title: 'Contrat de bail', subtitle: 'Accord d’hébergement village', href: '/documents/contrat-bail', menuIds: ['documents.contrat-bail'] },
    { title: 'Politique', subtitle: 'Politiques RH de référence', href: '/politique', menuIds: ['politique.longs-etats', 'politique.convention-collective', 'politique.heures-sup', 'politique.paie', 'politique.village', 'politique.code-conduite', 'politique.code-ethique', 'politique.manuco', 'politique.aide-medicale', 'politique.voyages', 'politique.alcool', 'politique.harcelement', 'politique.exploitation', 'politique.cas-disciplinaires'] },
    ...
    { title: 'Convention collective', subtitle: 'Clauses et résumés', href: '/politique/convention-collective', menuIds: ['politique.convention-collective'] },
    ...
    { title: 'SMIG & simulation de paie', subtitle: 'SMIG RDC et bulletin indicatif', href: '/politique/paie', menuIds: ['politique.paie'] },
    ...
    { title: 'Politique d’exploitation', subtitle: 'Règles d’exploitation des sites', href: '/politique/doc/exploitation', menuIds: ['politique.exploitation'] },
    { title: 'Gestion des cas disciplinaires', subtitle: 'Procédure disciplinaire', href: '/politique/doc/cas-disciplinaires', menuIds: ['politique.cas-disciplinaires'] },
    ...
    { title: 'CSR', subtitle: 'Projets CSR', href: '/project/csr', menuIds: ['project.projects'] },
    { title: 'Cahier de charges', subtitle: 'Projets Cahier de charges', href: '/project/cahier-de-charges', menuIds: ['project.projects'] },
